        ...
        <div className="container mx-auto py-10">
            ...
            <Card className="max-w-2xl mx-auto">
                <CardHeader>
                    ...
                    <CardDescription>Step 1 of 3: Enter customer details</CardDescription>
                </CardHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <CardFooter className="flex justify-between py-10">
                            <Button type="button" variant="outline" onClick={() => router.push("/customer")}>
                                Cancel
                            </Button>
                            <Button type="submit" disabled={isSubmitting}>
                                {isSubmitting ? "Saving..." : "Next: Vehicle Details"}
                            </Button>
                        </CardFooter>
                    </form>
                </Form>
